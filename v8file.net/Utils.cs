...
namespace v8file.net
{
    public class Utils
    {
        ...
        static readonly string[] days =
       {
        ...
        //public static byte[] Advance(byte[] bytes, int offset)
        //{
        //    byte[] dstBytes = new byte[bytes.Length - offset];
        //    Array.Copy(bytes, offset, dstBytes, 0, bytes.Length - offset);
        //    return dstBytes;
        //}
        ...
        //public static T ReadStruct<T>(BinaryReader br) where T: class, new()
        //{
        //    byte[] bytes = br.ReadBytes(Marshal.SizeOf(typeof(T)));
        //    return ByteToType<T>(bytes);
        //}
