...
namespace v8file.net
{
    public class LevelTableElm
    {
        ...
        public void Dump(StreamWriter sw, int level)
        {
            ...
            sw.WriteLine($"{ident}ParentId={((ParentId == 0xffffffff) ? -1 : ParentId)}");
            sw.WriteLine($"{ident}Dummy1={Dummy1}");
            sw.WriteLine($"{ident}Dummy2={Dummy2}");
            sw.WriteLine($"{ident}OverrideStyle={OverrideStyle}");
            sw.WriteLine($"{ident}OverrideWeight={OverrideWeight}");
            sw.WriteLine($"{ident}OverrideColor={OverrideColor}");
            sw.WriteLine($"{ident}OverrideColor1={OverrideColor1}");
            sw.WriteLine($"{ident}ByLevelStyle={ByLevelStyle}");
            sw.WriteLine($"{ident}ByLevelWeight={ByLevelWeight}");
            sw.WriteLine($"{ident}ByLevelColor={ByLevelColor}");
            sw.WriteLine($"{ident}ByLevelColor1={ByLevelColor1}");
